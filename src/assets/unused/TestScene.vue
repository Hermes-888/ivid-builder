						...
						sceneData: [
							{
								...
								cueData: [
									{
										// TEST CUES
										start: 1.2,// seconds: set Manually for now
										type: 'DragImage',
										useBlur: false,
										useOverlay: false,
										animateIn: false,
										...
										textColor: '#3023ba',
										messageTop: '15%',
										message: 'Drop the image onto the steak',
										feedback: '<b>Correct</b> <p>Good Job</p>',
										wrongFeedback: 'Sorry, you didn\'t find it.',
										points: 5,
										oneChance: false,// true=only drop once
										dropzone: {
											dropzone: true,
											hotspots: [
												{
									...
									{
										start: 2.0,// seconds: set Manually for now
										type: 'MultipleAnswer',
										useOverlay: true,
										animateIn: true,
										animateOut: true,
										...
										pauseVideo: true,
										resumePlayback: true,
										questionText: 'What should you look for?',
										questionAudio: 'audio/english/what_next.mp3',
										correctFeedbackText: 'Well done. Food hazards come in many forms.',
										correctFeedbackAudio: 'audio/english/feedback.mp3',
										wrongFeedbackText: 'Sorry, you should be looking for Physical, Chemical and Biological hazards.',
										wrongFeedbackAudio: 'audio/english/nope.mp3',
										randomizeAnswers: true,
										answers: [
											{
												id: 0,
												answerText: 'Ingredients',
												answerAudio: 'audio/english/foundit.mp3',
												correct: false
											},
											{
												id: 1,
												answerText: 'Pesticides',
												answerAudio: 'audio/english/foundit.mp3',
												correct: true
											},
											{
												id: 2,
												answerText: 'Dirty dishes',
												answerAudio: 'audio/english/foundit.mp3',
												correct: true
											},
											{
									...
									},
									{
										...
										infoTitle: 'This is a panel Title',
										titleColor: '#ffffff',
										infoText: 'This is the information to display. This is the information to display. This is the information to display. This is the information to display. This is the information to display. This is the information to display. This is the information to display.',
										buttonText: 'I Agree',
									},
									{
										// testing cue:
										...
										resumePlayback: true,
										// type properties:
										textBig: 'This is the Title',// H1
										textBigColor: '#000000',
										textSmall: 'This is the information to display. This is the information to display. This is the information to display. This is the information to display. This is the information to display. This is the information to display. This is the information to display.',
										textSmallColor: '#333333',
										textSmallWidth: '30%',
										textSmallBkgColor: 'rgba(174,234,236,0.6)',
										btnText: 'CONTINUE',
										btnTextColor: '#333333',// button text color
										btnBkgColor: '#aeeaec',// '#ffffff',
										//btnBorderColor: '#333333',// Todo: add borderColor?
									},
									{
										start: 4.2,// seconds: set Manually for now
										type: 'FlashCard',
										useBlur: false,
										useOverlay: false,
										animateIn: true,
										...
										cardWidth: '30%',
										buttonText: 'Continue',
										textFront: 'What temperature kills pathogens in Poultry?',
										textBack: 'Poultry should be cooked to 165° F',
										imgFront: '',
										imgBack: '',
										colorFront: '#0375A3',
										colorBack: '#7bc277',
										colorTextFront: '#ffffff',
										colorTextBack: '#333333',
										// textSizeFront: '',
										// textSizeBack: '',
										headerFront: 'Question',
										headerBack: 'Answer',
										footerFront: 'Click to show the answer',
										footerBack: 'Click the continue button'
									},
										// END TEST CUES
									{
										// manually set the time to pause at. this will get converted to a vttCue
